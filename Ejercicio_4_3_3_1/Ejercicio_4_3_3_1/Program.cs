                    ...
                    switch (opcion)
                    {
                        case '1':
                            if (posicion < capacidad)
                            {
                                ...
                                int nombreTiempo = Convert.ToInt32(Console.ReadLine());
                                cancion[posicion].tiempo.minutos = nombreTiempo;

                                Console.Write("Segundos:");
                                int nombreSegundos = Convert.ToInt32(Console.ReadLine());
                                cancion[posicion].tiempo.segundos = nombreSegundos;
                        ...
                        case '3':
                            ...
                            for (int i = 0; i < posicion; i++)
                            {
                                if (cancion[i].artista == buscar || cancion[i].titulo == buscar)
                                {
                                    ...
                                    Console.WriteLine(cancion[i].tiempo.minutos);
                                    Console.WriteLine(cancion[i].tiempo.segundos);
